			...
			<main class="flex-shrink-0">
			  ...
			  <div class='card'>
				    ...
				    <div class='card-body'>
							...
							<form:form modelAttribute="insert_contribuente_attr" method="post" action="save" class="row g-3" novalidate="novalidate">
								...
								<div class="col-md-6">
									...
									<spring:bind path="codiceFiscale">
										<input type="text" name="codiceFiscale" id="codiceFiscale" class="form-control ${status.error ? 'is-invalid' : ''}" placeholder="Inserire il Codice Fiscale" value="${insert_contribuente_attr.codiceFiscale }" required>
									</spring:bind>
								...
								<div class="col-md-6">
									...
									<spring:bind path="indirizzo">
										<input type="text" name="indirizzo" id="indirizzo" class="form-control ${status.error ? 'is-invalid' : ''}" placeholder="Inserire indirizzo" value="${insert_contribuente_attr.indirizzo }" required>
									</spring:bind>
