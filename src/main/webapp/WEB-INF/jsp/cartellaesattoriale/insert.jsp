			...
			<main class="flex-shrink-0">
			  ...
			  <div class='card'>
				    <div class='card-header'>
				        <h5>Inserisci nuovo Cartella Esattoriale</h5> 
				    </div>
				    <div class='card-body'>
							...
							<form:form modelAttribute="insert_cartella_attr" method="post" action="save" class="row g-3" novalidate="novalidate">
							
							
								<div class="col-md-6">
									<label for="descrizione" class="form-label">Descrizione <span class="text-danger">*</span></label>
									<spring:bind path="descrizione">
										<input type="text" name="descrizione" id="descrizione" class="form-control ${status.error ? 'is-invalid' : ''}" placeholder="Inserire la descrizione" value="${insert_cartella_attr.descrizione }" required>
									</spring:bind>
								...
								<div class="col-md-6">
									...
									<spring:bind path="importo">
										<input type="text" name="importo" id="importo" class="form-control ${status.error ? 'is-invalid' : ''}" placeholder="Inserire l'importo" value="${insert_cartella_attr.importo }" required>
									</spring:bind>
								...
								<div class="col-md-3">
								    ...
								    <spring:bind path="stato">
									    <select class="form-select ${status.error ? 'is-invalid' : ''}" id="stato" name="stato" required>
									    	<option value="CREATA" selected> - Selezionare - </option>
